...
export default class PeriksaMandiri extends React.Component {
  constructor(props) {
    ...
    this.state = {
      questions: [
        `Apakah anda sedang demam/riwayat demam suhu > 38 °C ?`,
  ...
  rekapGejala = (result) => {
    if (this.state.qNo < this.state.questions.length - 1) {
      ...
      if (this.state.total + result === 0) {
        ...
        Hubungi Puskesmas terdekat atau call-center 119.`;
  ...
  render() {
    return (
      <>
                    ...
                    <li className="list-group-item">
                      <div>
                        {this.state.resultStatus ? (
                          ...
                          this.state.questions[this.state.qNo]
                        )}
                      </div>
        ...
        <div className="bg-light pt-4 mt-0 pb-3">
          <div className="container">
            <div className="row">
