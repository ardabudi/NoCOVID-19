  ...
  render() {
    return (
      <>
        ...
        >
          <div className="container">
            <div className="accordion skrining-card mb-3" id="accordionExample">
                ...
                >
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col-sm-4" style={{ textAlign: "center" }}>
                        <img
                          src="https://corona.jakarta.go.id/img/logo/sesak-napas.png"
                          alt="corona.jakarta.go.id"
                        />
                        <div>Sesak Napas</div>
                      </div>
              ...
              <div className="card">
                <div className="card-header bg-transparent" id="headingFour">
                  <h2 className="mb-0">
                    <button
                      className="btn btn-sm collapsed"
                      type="button"
                  ...
                  <div className="card-body">
                    <ol>
                      <li>
                        ...
                        20 detik, atau dengan hand sanitizer yang mangandung
                        alkohol, trutama sebelum san sesudah bersin, batuk, atau
              ...
              <div className="card">
                ...
                >
                  <div className="card-body">
                    ...
                    <p>
                      <strong>Sumatera_Selatan</strong>
                    </p>
                    ...
                    <p>
                      <strong>Kep. Bangka Belitung</strong>
                    </p>
                    {data.Kep_Bangka_Belitung.map((e, index) => (
                      <p key={index} onClick={() => this.goMap(e)}>
                        {index + 1}. {e}
                      </p>
                    ))}
                    ...
                    <p>
                      <strong>Sulawesi_Selatan</strong>
                    </p>
                    ...
                    <p>
                      <strong>Sulawesi_Tenggara</strong>
                    </p>
                  ...
                  <div className="card-body">
                    ...
                    <ol>
                      ...
                      <li>
                        ...
                        pada lingkungan permukaan dataran biarkan tetap basah
                        selama 10 menit.
                      </li>
                      <li>
        ...
        <div className="bg-light pt-4 mt-0 pb-4">
          <div className="container">
            <div className="row">
